...
const Header = () => {
  return (
    <header className="sticky top-0 z-10 w-full py-3">
      <div className="container mx-auto rounded-lg bg-transparent backdrop-blur-md border-[0.5px] border-violet/20 shadow-[0_4px_30px_rgba(0,0,0,0.1)] px-6 py-3 flex justify-between items-center bg-gradient-to-r from-transparent via-violet/5 to-transparent">
